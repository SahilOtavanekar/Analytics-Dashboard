...
if top_events.empty:
    ...
    st.altair_chart(top_events_bar(top_events, "EVENT_NAME", "EVENT_COUNT"), use_container_width=True)
...
if event_share.empty:
    ...
    st.altair_chart(share_stacked_bar(event_share, "EVENT_TYPE", "EVENT_COUNT"), use_container_width=True)
    with st.expander("View as table"):
